...
export const IP_REGEX_STRICT = `^(${BYTE_REGEXP}\\.){3}${BYTE_REGEXP}$`;
...
export const WILDCARD_REGEX_STRICT         = `${FIRST_ORDER_WILDCARD_REGEX}|${SECOND_ORDER_WILDCARD_REGEX}|${THIRD_ORDER_WILDCARD_REGEX}|${FULL_WILDCARD_REGEX}`;